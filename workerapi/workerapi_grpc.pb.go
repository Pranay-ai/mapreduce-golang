...
const (
	WorkerApi_HealthCheck_FullMethodName = "/WorkerApi/HealthCheck"
)
...
func (c *workerApiClient) HealthCheck(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthCheckResponse)
	err := c.cc.Invoke(ctx, WorkerApi_HealthCheck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedWorkerApiServer must be embedded to have
...
func (UnimplementedWorkerApiServer) HealthCheck(context.Context, *HealthCheckRequest) (*HealthCheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HealthCheck not implemented")
}
func (UnimplementedWorkerApiServer) mustEmbedUnimplementedWorkerApiServer() {}
func (UnimplementedWorkerApiServer) testEmbeddedByValue()                   {}
...
func RegisterWorkerApiServer(s grpc.ServiceRegistrar, srv WorkerApiServer) {
	// If the following call pancis, it indicates UnimplementedWorkerApiServer was
...
func _WorkerApi_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthCheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkerApiServer).HealthCheck(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorkerApi_HealthCheck_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerApiServer).HealthCheck(ctx, req.(*HealthCheckRequest))
	}
...
var WorkerApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "WorkerApi",
	HandlerType: (*WorkerApiServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "HealthCheck",
			Handler:    _WorkerApi_HealthCheck_Handler,
		},
	},
